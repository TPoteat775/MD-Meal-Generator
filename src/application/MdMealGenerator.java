...
public class MdMealGenerator {
    ...
    public static ArrayList<Location> createLocations() throws IOException {
		String line;
    ...
    public static void createMeals(){
        ...
        ImageIcon mealIcon = null;  //icon to be associated with meal
            ...
            while(scanner.hasNext()){
                ...
                switch(line){
                    ...
                    case "ID":
                        ...
                        try{
                            mealIcon = new ImageIcon(mealID + ".jpg");
                        }
                        catch(Exception e){
                            mealIcon = new ImageIcon("notFound.png");
                        }
                        break;
    ...
    public static void createMealsExcludingDislikes(User user){
        ...
        if(userDis.size() > 0){
            ...
            for(int i = 0; i < userDis.size(); i++){
                ...
                for(int j = 0; j < meals.size(); j++){
                    //get meal
                    tempMeal = meals.get(j);
                    //if meal is not disliked, add to exclude dislikes arrayList
                    if(!tempMealName.equals(tempMeal.getMealName())){
                        excludeDislikes.add(tempMeal);
                    }
                }
            }
        }      
